...
#bz 812449 - df: dereference symlinks for device nodes
Patch107: coreutils-8.4-df-symlinkdereference.patch
#bz 1098078 - dd: add support for count_bytes iflag
Patch108: coreutils-8.4-dd-iflagcountbytes.patch
#bz 1016163 - id/groups - print correct group id for no user name argument
Patch109: coreutils-8.4-id-nouserargument.patch
...
#document default behaviour for symlinks in manpage (#1064621)
...
* Tue Jul 15 2014 Ondrej Vasik <ovasik@redhat.com> - 8.4-36
- don't include id-setgid test, this root-only test fails
  in some environments (false alarms)

* Thu Jun 26 2014 Ondrej Vasik <ovasik@redhat.com> - 8.4-35
- id/groups - print correct group for session (#1016163)

* Fri Jun 13 2014 Ondrej Vasik <ovasik@redhat.com> - 8.4-34
- tail: disable inotify in --follow for vxfs (#1104244)
- df: dereference symlinks to disk device nodes (#812449)
- dd: add support for count_bytes iflag (#1098078)

* Mon May 05 2014 Ondrej Vasik <ovasik@redhat.com> - 8.4-33
- su: don't terminate parent process upon SIGTERM(#1063887)
- tail: do not show "reverting to polling" warning when not
  necessary (#1046818)
- chcon: document default behaviour for symlink (#1064621)
- fix dd sparse test failure on XFS (#1075679)

* Wed Mar 05 2014 Ondrej Vasik <ovasik@redhat.com> - 8.4-32
- df: print the devices longer than 20 chars on separate
  line again in non-posix mode (#1057026)
